...
<div align="center">
  ...
  <img src="https://github.com/Admiral23kizaru.png" width="150" style="border-radius: 50%; border: 4px solid #4f9eff;" />

  # Hi, I’m Aaron! 👋
  ### *Building the Future with Code, Cloud & AI* 🚀
  
  [![Typing SVG](https://readme-typing-svg.herokuapp.com?color=4F9EFF&lines=Full+Stack+Developer;Mobile+App+Wizard;AI+Automation+Builder;DevOps+Enthusiast;Open+Source+Contributor)](https://git.io/typing-svg)
...
## 👨‍💻 About Me
Based in the Philippines 🇵🇭, I am a passionate software engineer who loves turning complex problems into simple, beautiful, and intuitive designs.  

- 🔭 **Working on:** Scalable Full-Stack Web Apps & Mobile Solutions  
- 🌱 **Learning:** Generative AI, Advanced DevOps (K8s), and Rust  
- 🤖 **Expertise:** Automation with **n8n**, **React Native** Mobile Apps, and **AI Integration**  
- 💬 **Ask me about:** React, Node.js, PHP/Laravel, and System Architecture  
...
| :--- | :--- | :--- |
| **Platform3** | `PHP` `MySQL` `Bootstrap` | A comprehensive school management system for tracking students and grades. |
| **FoundIt** | `React Native` `Firebase` | Offline-first Lost & Found mobile application with geolocation tracking. |
| **HelpTap** | `MERN Stack` | Hyperlocal task assistance platform (Uber for chores) with real-time chat. |
| **InventorySys** | `Laravel` `Vue.js` | Intelligent inventory management with low-stock alerts and analytics dashboard. |
