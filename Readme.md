<div align="center">
  ...
  ## Aaron
  ### Software Engineer — Full Stack · Mobile · AI & Automation

  [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=18&pause=1000&color=4F9EFF&center=true&vCenter=true&width=520&lines=Full+Stack+Web+Engineer;React+Native+Mobile+Developer;AI+Integration+%26+Automation+Specialist;DevOps+%26+Cloud+Infrastructure)](https://git.io/typing-svg)
...
| :--- | :--- | :--- |
| **Platform3** | `PHP` `MySQL` `Bootstrap` | Comprehensive school management system for academic record tracking, grade management, and student monitoring. |
| **FoundIt** | `React Native` `Firebase` | Offline-first lost and found mobile application with geolocation tracking and real-time sync. |
| **HelpTap** | `MongoDB` `Express` `React` `Node.js` | Hyperlocal task assistance platform — on-demand service matching with real-time chat and live tracking. |
| **InventorySys** | `Laravel` `Vue.js` `MySQL` | Inventory management system with automated low-stock alerts, reporting, and an analytics dashboard. |
...
<div align="center">
  ...
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=Admiral23kizaru&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&hide_border=true" />
  <img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Admiral23kizaru&layout=compact&theme=tokyonight&hide_border=true&langs_count=8" />
