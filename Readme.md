...
- **UI/UX Design:** Designing clean, user-friendly interfaces with attention to layout, usability, and visual consistency
- **Networking:** Familiar with network fundamentals and simulation through Cisco Packet Tracer
- **AI & Automation:** Exploring workflow automation with n8n and LLM integration through hands-on projects
- **Prompt Engineering:** Learning how to structure and optimize prompts for LLMs to get reliable, production-useful outputs
...
| :--- | :--- | :--- |
| **Platform3** |    | Comprehensive school management system for academic record tracking, grade management, and student monitoring. |
| **FoundIt** |   | Lost and found web application with geolocation tracking and real-time database sync. |
| **HelpTap** |     | Hyperlocal task assistance platform — on-demand service matching with real-time chat and live tracking. |
| **InventorySys** |    | Inventory management system with automated low-stock alerts, reporting, and an analytics dashboard. |
